...
public class SCBLogger {
	...
	public SCBLogger(String name) {
		System.out.println("Scblogger constructor");
	...
	private void log(Level logLevel, String msg, String... labels) {
		System.out.println("log method, checking, remote enabled "+isRemoteLoggingEnabled());
	...
	private void invokeAsyncRestLogging(LogEntry logEntry) {
		System.out.println("remote url"+PropertyHolder.getLoggingServiceURL());
		String url="http://localhost:9000/api/v1/logs/addLog";
		...
		ListenableFuture<ResponseEntity<Long>> futureEntity = asyncRestClient
				.postForEntity(url, entity, Long.class);
	...
	private com.capco.logger.LogEntry buildLogEntry(Level logLevel, String msg, String... labels) {
